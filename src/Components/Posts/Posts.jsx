              ...
              <div className="col-md-3 product-container" key={index}>
                ...
                <div className="product-description-box">
                  ...
                  <span className='other-view-product'>
                    {obj.companyName.length >= 30 ? <h5>{obj.companyName.slice(0, 40)}...</h5> : <h5>{obj.companyName}</h5>}
                    {obj.name.length >= 24 ? <h4 >{obj.name.slice(0, 30)}....</h4> : <h4>{obj.name}</h4>}
                    <h6><i className="fa-solid fa-indian-rupee-sign"></i> {obj.price.toLocaleString()}</h6>
                    {obj.description.length >= 35 ? <h5 >{obj.description.slice(0, 45)}....</h5> : <h5>{obj.description}</h5>}
                  </span>
                </div>
              </Link>
              </div>
